...
function IndicatorHistoryModal({ indicador, onClose }) {
  ...
  useEffect(() => {
    ...
    if (indicador.fuente === 'mindicador' || indicador.fuente === 'bcentral') params.set('codigo', indicador.codigo);
    ...
    <div style={styles.modalFondo} onClick={onClose}>
      <div style={{ ...styles.modalCaja, maxWidth: '680px' }} onClick={(e) => e.stopPropagation()}>
        ...
        <p style={styles.fuente}>
          Fuente: {indicador.fuente === 'mindicador'
            ? 'mindicador.cl (Banco Central de Chile / INE)'
            : indicador.fuente === 'bcentral'
              ...
              onClick={
                idx.valor != null
                  ? () =>
                      setHistorialAbierto(
                        i === 0
                          ? { label: idx.label, fuente: 'bcentral', codigo: 'ipsa' }
                          : { label: idx.label, fuente: 'yahoo', ticker: TICKERS_INDICES[i] }
                      )
                  : undefined
              }
            />
...
const styles = {
  ...
  wxFondo: {
    position: 'fixed', inset: 0, background: 'rgba(5,10,15,0.55)',
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    zIndex: 1000, padding: '20px',
  },
  wxCaja: {
    ...
    maxHeight: '85vh', overflowY: 'auto', boxShadow: '0 20px 60px rgba(0,0,0,0.35)',
    color: 'var(--paper-100)', fontFamily: 'var(--font-body)',
  },
  wxCerrar: {
    position: 'absolute', top: '14px', right: '14px', background: 'var(--navy-800)',
    border: '1px solid var(--navy-700)', color: 'var(--paper-100)', borderRadius: '50%',
  ...
  wxLoading: { fontSize: '0.85rem', color: 'var(--paper-100)' },
  wxError: { fontSize: '0.85rem', color: 'var(--coral-500)' },
  wxHero: { textAlign: 'center', marginBottom: '22px' },
  wxLugar: { fontSize: '1.05rem', fontWeight: 500, margin: '0 0 2px', color: 'var(--paper-050)' },
  wxTemp: { fontFamily: 'var(--font-body)', fontSize: '4.2rem', fontWeight: 200, margin: '0', lineHeight: 1, color: 'var(--gold-500)' },
  wxDesc: { fontSize: '0.95rem', color: 'var(--paper-100)', margin: '2px 0 0' },
  wxMinMax: { fontSize: '0.85rem', color: 'var(--paper-100)', margin: '4px 0 0' },
  wxCard: {
    background: 'var(--navy-800)', border: '1px solid var(--navy-700)', borderRadius: '14px', padding: '14px', marginBottom: '12px',
  },
  wxCardTitulo: {
    fontSize: '0.68rem', textTransform: 'uppercase', letterSpacing: '0.04em', color: 'var(--paper-100)',
  ...
  wxHoraTexto: { fontSize: '0.72rem', color: 'var(--paper-100)', margin: '0 0 8px' },
  wxHoraIcono: { fontSize: '1.3rem', margin: '0 0 6px' },
  wxHoraProb: { fontSize: '0.66rem', color: 'var(--gold-500)', margin: '0 0 6px', fontWeight: 600 },
  wxHoraTemp: { fontSize: '0.9rem', fontWeight: 500, margin: 0, color: 'var(--paper-050)' },
  wxDiaFila: {
  ...
  wxDiaNombre: { fontSize: '0.85rem', fontWeight: 500, color: 'var(--paper-050)' },
  wxDiaIcono: { fontSize: '1.05rem', textAlign: 'center' },
  wxDiaProb: { fontSize: '0.66rem', color: 'var(--gold-500)', fontWeight: 600, textAlign: 'center' },
  wxDiaMin: { fontSize: '0.82rem', color: 'var(--paper-100)', textAlign: 'right' },
  wxDiaMax: { fontSize: '0.82rem', fontWeight: 500, textAlign: 'right', color: 'var(--paper-050)' },
  wxDiaBarraPista: {
    position: 'relative', height: '4px', borderRadius: '2px', background: 'var(--navy-700)',
  },
  wxDiaBarra: {
    position: 'absolute', top: 0, bottom: 0, borderRadius: '2px',
    background: 'linear-gradient(90deg, var(--cal-green), var(--gold-500), var(--cal-red))',
  },
  wxGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' },
  wxTile: {
    background: 'var(--navy-800)', border: '1px solid var(--navy-700)', borderRadius: '14px', padding: '12px 14px', minHeight: '84px',
  },
  wxTileLabel: {
    fontSize: '0.66rem', textTransform: 'uppercase', letterSpacing: '0.04em', color: 'var(--paper-100)',
    margin: '0 0 8px', fontWeight: 600,
  },
  wxTileValor: { fontSize: '1.4rem', fontWeight: 500, margin: 0, color: 'var(--paper-050)' },
  wxTileNota: { fontSize: '0.72rem', color: 'var(--paper-100)', margin: '4px 0 0', lineHeight: 1.35 },
  wxFuente: { fontSize: '0.68rem', color: 'var(--paper-100)', margin: '14px 0 0', textAlign: 'center' },
};
